...
% processed by CNN baseline networks in tensorflow (for efficiency)
...
tf_path = './tf_data/cnnbaseline_eval_eeg/';
...
%% EOG
listing = dir([mat_path, '*_cnnbaseline_eog.mat']);
tf_path = './tf_data/cnnbaseline_eval_eog/';
if(~exist(tf_path, 'dir'))
    mkdir(tf_path);
end
...
%% EMG
listing = dir([mat_path, '*_cnnbaseline_emg.mat']);
tf_path = './tf_data/cnnbaseline_eval_emg/';
if(~exist(tf_path, 'dir'))
    mkdir(tf_path);
end
